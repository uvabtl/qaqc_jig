...
h_res_avg_bar = ROOT.TH1F('h_res_avg_bar','',10,0.,.1)
h_res_avg_ch = ROOT.TH1F('h_res_avg_ch','',10,0.,.1)
...
ROOT.gPad.SetGridx()
ROOT.gPad.SetGridy()
h_res_avg_bar.SetTitle(';bar light output [pe/MeV];entries')
...
ROOT.gPad.SetGridx()
ROOT.gPad.SetGridy()
h_res_avg_ch.SetTitle(';bar light output [pe/MeV];entries')
